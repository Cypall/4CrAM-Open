...
static void display_title(void) {
	...
	ShowMessage("" CL_WTBL "     " CL_BT_GREEN "                    4CrAM-Open Development Team presents                 " CL_WTBL "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_WTBL "     " CL_BOLD "       ___     _____      ___     ___   ___        _____ _____ ____  _     __" CL_WTBL "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_WTBL "     " CL_BOLD "      / . |   / ___/_____/   |   /   | /   |      / __  / _   / __ \\/ \\   / /" CL_WTBL "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_WTBL "     " CL_BOLD "     / /| |__/ /   / ___/ /| |  / /| |/ /| | ___ / / / / /_/ / /_/_/ . \\ / / " CL_WTBL "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_WTBL "     " CL_BOLD "    /___  __/ /___/ /  / ___ | / / |   / | |/__// /_/ / ____/ /___/ / \\ ' /  " CL_WTBL "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_WTBL "     " CL_BOLD "        |_|/_____/_/  /_/  |_|/_/  |__/  |_|   /_____/_/   /_____/_/   \\_/   " CL_WTBL "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_WTBL "     " CL_BT_CYAN "                  (4th Class rAthena Mod - OpenSource)                          " CL_WTBL "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_WTBL "     " CL_BOLD "                                                                             " CL_WTBL "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_WTBL "     " CL_BOLD "                                                                             " CL_WTBL "" CL_CLL "" CL_NORMAL "\n");
	ShowMessage("" CL_WTBL "     " CL_BOLD "                                                                             " CL_WTBL "" CL_CLL "" CL_NORMAL "\n");
